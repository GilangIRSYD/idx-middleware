/**
 * Domain entity representing emiten trading detail for a specific date
 */
export class EmitenDetail {
  constructor(
  ...
  static create(
    ...
    const status = EmitenDetail.determineStatus(netVolume);

    return new EmitenDetail(
      date,
      buyVolume,
      sellVolume,
      netVolume,
...
export interface EmitenDetailDTO {
  date: string;
  buy_volume: number;
  sell_volume: number;
  net_volume: number;
